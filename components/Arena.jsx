...
const Arena = () => {
  return (
    // Added id="arena-section" and scroll-mt-20 to handle the fixed header offset
    <div id="arena-section" className="md:min-h-[90%] p-0 lg:p-8 md:mt-0 mt-60 scroll-mt-20">
       ...
       md:grid-cols-3 gap-4 md:gap-6">
        ...
        <div className="md:col-span-1 space-y-4 md:space-y-6">
            {/* card-1 */}
            <div className='relative overflow-hidden rounded-3xl border border-white aspect-[4.5/4] transform transition-transform duration-300
            hover:scale-105'>
                {/* card background */}
                <div className="absolute h-full w-full">
                    ...
                    hover:text-yellow-400 transition-all duration-300 text-nowrap'>
                      <i className='bx  bxs-store'  ></i>  NFT STORE
                    </button>
                </div>
            ...
            <div className='md:col-span-2 space-y-4 md:space-y-6'>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6'>
                ...
                border border-white aspect-square transform transition-transform duration-300 hover:scale-105'>
                  <video className='w-full h-full object-cover' autoPlay loop muted playsInline src="/videos/bento-card3.mp4"></video>
